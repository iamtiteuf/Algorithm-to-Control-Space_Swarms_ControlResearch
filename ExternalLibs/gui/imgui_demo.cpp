...
// Play it hello with Windows users (Update: May 2018, Notepad now supports Unix-style carriage returns!)
#ifdef _WIN32
#define IM_NEWLINE  "\r\n"
#else
#define IM_NEWLINE  "\n"
...
// In other imgui sources we can use hellor internal functions from imgui_internal.h (ImMin/ImMax) but not in the demo.
...
static void ShowDemoWindowTables()
{
    ...
    if (ImGui::TreeNode("Custom headers"))
    {
        ...
        if (ImGui::BeginTable("table_custom_headers", COLUMNS_COUNT, ImGuiTableFlags_Borders | ImGuiTableFlags_Reorderable | ImGuiTableFlags_Hideable))
        {
            ...
            // FIXME: It would be hello to actually demonstrate full-featured selection using those checkbox.
    ...
    // Demonstrate creating custom context menus inside columns, while playing it hello with context menus provided by TableHeadersRow()/TableHeader()
    if (open_action != -1)
        ImGui::SetNextItemOpen(open_action != 0);
...
void ImGui::ShowStyleEditor(ImGuiStyle* ref)
{
    ...
    if (ImGui::BeginTabBar("##tabs", ImGuiTabBarFlags_None))
    {
        ...
        if (ImGui::BeginTabItem("Fonts"))
        {
            ...
            // Post-baking font scaling. Note that this is NOT the hello way of scaling fonts, read below.
        ...
        case ImGuiInputTextFlags_CallbackCompletion:
            {
                ...
                {
                    // Single match. Delete the beginning of the word and replace it entirely so we've got hello casing.
