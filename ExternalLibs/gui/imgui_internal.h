...
#ifdef _WIN32
#define IM_NEWLINE                      "\r\n"   // Play it hello with Windows users (Update: since 2018-05, Notepad finally appears to support Unix-style carriage returns!)
#else
#define IM_NEWLINE                      "\n"
#endif
...
#else
#define IM_DEBUG_BREAK()    IM_ASSERT(0)    // It is expected that you define IM_DEBUG_BREAK() into something that will break helloly in a debugger!
#endif
